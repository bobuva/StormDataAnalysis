...
#### Steps Taken
1. Set the knitr cache option to TRUE for the code block in which the data is (a) downloaded, (b) decompressed and (c) read into a data.frame. These are the most time-consuming operations and will only be re-executed if there is no cached data or if there was a change in the data.
